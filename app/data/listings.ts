...
export const LISTINGS: Listing[] = [
  ...
  {
    slug: "2025-kia-seltos-gt-line-demo",
    status: "available",
    badge: "DEMO",
    name: "2025 Kia Seltos GT-Line",
    subtitle: "2.0L Petrol · FWD · CVT Auto",
    ...
    images: [
      "https://d2s8i866417m9.cloudfront.net/photo/32860614/photo/medium-481b6aeb1760ebd3cb5b4fd57f60919b.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860624/photo/medium-56c62f9e2b48f6279d41165467c5250f.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860629/photo/medium-ac91dbea401b56b66f3c7f1d500e0cad.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860633/photo/medium-d97d41040a5f0675ba1d723e2cece898.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860638/photo/medium-05ea3172a2b45ecb1c7c9e54c42bc7e9.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860642/photo/medium-6823ce5f6f65336970fb37c28c9ab888.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860646/photo/medium-6ced8be682fbec9ef852bd2cc8f2ebf8.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860648/photo/medium-c6be2208aa4b5f4e1b25374952876f71.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860652/photo/medium-87511fdc39967b97077731f0fbb37433.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860654/photo/medium-4379bcde549f752885dbb2395f0f359c.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860658/photo/medium-ea2e6866924899e97cb3aef2da8f8c3a.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860662/photo/medium-08774814ce5a4b168770a8e6fc784766.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860666/photo/medium-879ac66e6d68b21d929f3461bd692376.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860669/photo/medium-5c98f303a350d93052fbaf130353f6a4.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/32860671/photo/medium-e8c0acfab41036ab29771a54bef4c41e.jpg",
    ],
    specs: [
      { label: "Year",         value: "2025" },
      { label: "Body",         value: "SUV · 5 doors" },
      { label: "Engine",       value: "2.0L 4-cylinder Petrol" },
      { label: "Transmission", value: "CVT Automatic" },
      { label: "Drive",        value: "Front Wheel Drive" },
      { label: "Fuel",         value: "6.0L/100km" },
      { label: "Colour",       value: "Snow White Pearl" },
      { label: "Interior",     value: "Black" },
      { label: "Seats",        value: "5" },
    ],
    dealerComment: "GT-Line in Snow White Pearl with only 175km. Fully loaded with panoramic sunroof, heads-up display, wireless CarPlay, heated and ventilated seats, and 7-year unlimited km warranty. Drive away pricing with no additional on-road costs.",
    features: [
      { name: '18" Alloy Wheels',                          descEn: 'Factory 18-inch alloy wheels in GT-Line specification',                               descKo: '순정 18인치 GT-Line 알로이 휠' },
      { name: 'Panoramic Sunroof',                         descEn: 'Full-length panoramic glass sunroof with electric tilt and slide',                     descKo: '전동 틸트/슬라이드 풀 파노라믹 글라스 선루프' },
      { name: '10.25" Digital Instrument Cluster',         descEn: 'Fully digital 10.25-inch instrument display with customisable layouts',                descKo: '레이아웃 커스터마이징 가능한 10.25인치 풀 디지털 계기판' },
      { name: '10.25" Infotainment Display',               descEn: 'Large 10.25-inch central touchscreen with navigation and media controls',              descKo: '내비게이션 및 미디어 컨트롤 통합 10.25인치 중앙 터치스크린' },
      { name: 'Colour Head-Up Display',                    descEn: 'Colour HUD projecting speed, navigation and safety info onto the windscreen',          descKo: '속도·내비·안전 정보를 앞 유리에 투영하는 컬러 헤드업 디스플레이' },
      { name: 'Wireless Apple CarPlay / Android Auto',     descEn: 'Wireless smartphone integration with full display mirroring',                          descKo: '무선 애플 카플레이 및 안드로이드 오토 통합' },
      { name: 'Wireless Charging',                         descEn: 'Qi wireless charging pad for compatible smartphones',                                  descKo: '호환 스마트폰 무선 충전 패드' },
      { name: 'Heated and Ventilated Front Seats',         descEn: 'Front seats with both heating and ventilation for year-round comfort',                  descKo: '사계절 편안한 전방 시트 열선 및 통풍 기능' },
      { name: 'Heated Steering Wheel',                     descEn: 'Steering wheel with built-in heating for cold weather comfort',                        descKo: '겨울철 편안한 주행을 위한 열선 스티어링 휠' },
      { name: 'Adaptive Cruise Control',                   descEn: 'Speed and following distance maintained automatically, with road sign recognition',    descKo: '도로 표지판 인식 포함 차간거리·속도 자동 유지 어댑티브 크루즈 컨트롤' },
      { name: 'Blind Spot Collision Warning',              descEn: 'Alerts driver to vehicles in blind spots during lane changes',                          descKo: '차선 변경 시 사각지대 차량 경고 시스템' },
      { name: 'Rear Cross Traffic Alert',                  descEn: 'Warns of crossing traffic when reversing out of parking spaces',                       descKo: '주차 공간 후진 시 횡단 차량 경고' },
      { name: 'Lane Keeping Assist',                       descEn: 'Active steering intervention when drifting from lane markings',                        descKo: '차선 이탈 시 능동형 스티어링 개입 차선 유지 보조' },
      { name: 'Reversing Camera',                          descEn: 'Rear-view camera with guidance lines for safe parking',                                descKo: '주차 가이드 라인이 있는 후방 카메라' },
      { name: 'Parking Sensors',                           descEn: 'Ultrasonic front and rear parking sensors with proximity alerts',                      descKo: '전후방 초음파 주차 센서 및 근접 경고' },
      { name: 'Kia Connect',                               descEn: 'Connected car services including remote start, location tracking and OTA updates',     descKo: '원격 시동·위치 추적·OTA 업데이트 지원 커넥티드 카 서비스' },
      { name: '8 Speaker Stereo',                          descEn: '8-speaker audio system for clear, full sound throughout the cabin',                    descKo: '실내 전역 풍부한 사운드를 제공하는 8스피커 오디오 시스템' },
      { name: 'Dual Zone Climate Control',                 descEn: 'Independent temperature settings for driver and front passenger',                      descKo: '운전석·조수석 독립 온도 설정 듀얼존 공조 시스템' },
      { name: 'Power Tailgate',                            descEn: 'Hands-free electric tailgate with automatic open and close',                           descKo: '자동 개폐 핸즈프리 전동 테일게이트' },
    ...
    whyPriceMakesSense: {
      ...
      addedOptionsValue: 0,
      totalNewValue:     47000,
      mustgoDealsPrice:  45490,
    },
  },

  {
    slug: "2025-kia-tasman-sx-plus-demo",
    status: "available",
    badge: "DEMO",
    name: "2025 Kia Tasman SX+",
    subtitle: "2.2L Turbo Diesel · 4X4 Dual Range · Auto",
    location: "West Ryde, Sydney",
    km: 2037,
    colour: "Clear White",
    interiorColour: "Black",
    ...
    warranty: "7 year unlimited km warranty",
    images: [
      "https://d2s8i866417m9.cloudfront.net/photo/31291720/photo/medium-c3b4824473118d33012ae2f7f7a94011.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291724/photo/medium-265d98cabe4469632e94766e57803cbe.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291725/photo/medium-c9ccffb872bc9939ad5145dc8dcd68d2.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291726/photo/medium-2c31130caf54d21ed76f06cdecda6326.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291727/photo/medium-9cfbcf3e937a1c6816aef443726ec0df.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291728/photo/medium-cff79d91dc7678b945cd13ac3295733b.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291729/photo/medium-563d7acfd08678fe98152a09b5812ce7.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291730/photo/medium-8e94c1012f7bb9553db20b0fd0c521a2.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291731/photo/medium-7165f1e9b3be5240183eef39bb068500.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291732/photo/medium-a9027cba37bce1b59da77b354789d442.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291733/photo/medium-0bb036a4d40cb6377742c428c5215e6b.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291734/photo/medium-30bf0103aa146196d043181e02141721.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291735/photo/medium-70162b7f6b94e3193f28c972f3a12bea.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291736/photo/medium-26045342b1469081bc920791f04ddb0a.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291737/photo/medium-d39f6d9cc6ae0ea92c6c666b37002fd4.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291739/photo/medium-73ad875d651265addcbd6f09a0ffa800.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291740/photo/medium-f8dcd3e8d53f5e14d5971f425ddad288.jpg",
      "https://d2s8i866417m9.cloudfront.net/photo/31291741/photo/medium-c066096c1cd4bb87a23692c432bb22b2.jpg",
    ],
    specs: [
      { label: "Year",         value: "2025" },
      { label: "Body",         value: "Ute · Double Cab" },
      { label: "Engine",       value: "2.2L Turbo Diesel" },
      { label: "Transmission", value: "Automatic" },
      { label: "Drive",        value: "4X4 Dual Range" },
      { label: "Fuel",         value: "7.0L/100km" },
      { label: "Colour",       value: "Clear White" },
      { label: "Interior",     value: "Black" },
      { label: "Seats",        value: "5" },
    ],
    dealerComment: "Tasman SX+ Double Cab in Clear White with only 2,037km. Full 4X4 Dual Range capability with 2.2L turbo diesel, 240V outlet, tow bar ready, and 7-year unlimited km warranty. $15,000 below original drive away price.",
    features: [
      { name: '18" Alloy Wheels',                      descEn: 'Factory 18-inch alloy wheels suited for on and off-road use',                          descKo: '온/오프로드 겸용 순정 18인치 알로이 휠' },
      { name: '4X4 Dual Range with Low Range',         descEn: 'Full-time 4X4 with selectable low range for off-road and towing capability',          descKo: '오프로드·견인에 최적화된 로우 레인지 선택 가능 풀타임 4X4' },
      { name: '2.2L Turbo Diesel Engine',              descEn: 'Torque-rich 2.2L 4-cylinder turbo diesel for towing and highway efficiency',          descKo: '견인 및 고속도로 효율에 최적화된 2.2L 4기통 터보 디젤' },
      { name: 'Tow Bar',                               descEn: 'Factory-fitted tow bar for trailer and caravan towing',                               descKo: '트레일러 및 카라반 견인용 순정 토우 바' },
      { name: '240V Power Outlet',                     descEn: '240V household power outlet in the tray for powering tools and appliances on-site',    descKo: '현장에서 공구·가전제품 사용 가능한 적재함 내 240V 가정용 전원 콘센트' },
      { name: '12V Auxiliary Socket',                  descEn: '12V accessory socket for powering devices and accessories',                           descKo: '각종 디바이스 및 액세서리 연결용 12V 보조 소켓' },
      { name: 'Wireless Apple CarPlay / Android Auto', descEn: 'Wireless smartphone integration with full display mirroring',                         descKo: '무선 애플 카플레이 및 안드로이드 오토 통합' },
      { name: 'Adaptive Cruise Control',               descEn: 'Maintains speed and following distance automatically, with road sign recognition',    descKo: '도로 표지판 인식 포함 차간거리·속도 자동 유지 어댑티브 크루즈 컨트롤' },
      { name: 'Blind Spot Collision Warning',          descEn: 'Alerts driver to vehicles entering blind spots during lane changes',                   descKo: '차선 변경 시 사각지대 진입 차량 경고 시스템' },
      { name: 'Rear Cross Traffic Alert',              descEn: 'Warns of crossing traffic when reversing out of parking spaces',                      descKo: '주차 공간 후진 시 횡단 차량 경고' },
      { name: 'Lane Keeping Assist',                   descEn: 'Active steering intervention when drifting from lane markings',                       descKo: '차선 이탈 시 능동형 스티어링 개입 차선 유지 보조' },
      { name: 'Reversing Camera',                      descEn: 'Rear-view camera with guidance lines for safe parking and towing',                    descKo: '주차·견인 시 안전을 위한 가이드 라인 후방 카메라' },
      { name: 'Parking Sensors',                       descEn: 'Ultrasonic front and rear parking sensors with proximity alerts',                     descKo: '전후방 초음파 주차 센서 및 근접 경고' },
      { name: 'Heated Front Seats',                    descEn: 'Front seat heating for cold weather comfort',                                         descKo: '겨울철 편안한 주행을 위한 전방 시트 열선' },
      { name: '6 Speaker Stereo',                      descEn: '6-speaker audio system for clear sound throughout the cabin',                         descKo: '실내 전역 풍부한 사운드를 제공하는 6스피커 오디오 시스템' },
      { name: 'Dual Zone Climate Control',             descEn: 'Independent temperature settings for driver and front passenger',                     descKo: '운전석·조수석 독립 온도 설정 듀얼존 공조 시스템' },
      { name: 'ANCAP 5 Star Safety Rating',           descEn: 'Maximum 5-star ANCAP safety rating',                                                  descKo: '최고 등급 ANCAP 5스타 안전 인증' },
...

  {
    ...
    specs: [
      ...
      { label: "Transmission", value: "Automatic" },
      { label: "Drive",        value: "Front Wheel Drive" },
      { label: "Fuel",         value: "8.0L/100km" },
      { label: "Colour",       value: "Clear White" },
      { label: "Interior",     value: "Black" },
      { label: "Seats",        value: "5" },
    ],
    dealerComment: "Sportage S in Clear White with only 2,003km. Fully drive away priced with no additional on-road costs. 7-year unlimited km warranty included.",
    features: [
      { name: '17" Alloy Wheels',                      descEn: 'Factory 17-inch alloy wheels in Sportage S specification',                              descKo: '순정 17인치 스포티지 S 스펙 알로이 휠' },
      { name: 'Wireless Apple CarPlay / Android Auto', descEn: 'Wireless smartphone integration with full display mirroring',                           descKo: '무선 애플 카플레이 및 안드로이드 오토 통합' },
      { name: 'Adaptive Cruise Control',               descEn: 'Maintains speed and following distance automatically, with road sign recognition',      descKo: '도로 표지판 인식 포함 차간거리·속도 자동 유지 어댑티브 크루즈 컨트롤' },
      { name: 'Blind Spot Collision Warning',          descEn: 'Alerts driver to vehicles entering blind spots during lane changes',                    descKo: '차선 변경 시 사각지대 진입 차량 경고 시스템' },
      { name: 'Rear Cross Traffic Alert',              descEn: 'Warns of crossing traffic when reversing out of parking spaces',                        descKo: '주차 공간 후진 시 횡단 차량 경고' },
      { name: 'Lane Keeping Assist',                   descEn: 'Active steering intervention when drifting from lane markings',                         descKo: '차선 이탈 시 능동형 스티어링 개입 차선 유지 보조' },
      { name: 'Reversing Camera',                      descEn: 'Rear-view camera with guidance lines for safe parking',                                 descKo: '주차 가이드 라인이 있는 후방 카메라' },
      { name: 'Front and Rear Parking Sensors',        descEn: 'Ultrasonic front and rear parking sensors with proximity alerts',                       descKo: '전후방 초음파 주차 센서 및 근접 경고' },
      { name: '12.3" Multimedia Touchscreen',          descEn: 'Large 12.3-inch central touchscreen with navigation and media controls',                descKo: '내비게이션 및 미디어 컨트롤 통합 12.3인치 중앙 터치스크린' },
      { name: 'Keyless Entry',                         descEn: 'Keyless smart entry and push-button start',                                             descKo: '스마트 키리스 엔트리 및 버튼 시동' },
      { name: 'Leather Steering Wheel',                descEn: 'Leather-wrapped multifunction steering wheel',                                          descKo: '가죽 감싸기 멀티펑션 스티어링 휠' },
      { name: 'Dual Zone Climate Control',             descEn: 'Independent temperature settings for driver and front passenger',                       descKo: '운전석·조수석 독립 온도 설정 듀얼존 공조 시스템' },
      { name: 'ANCAP 5 Star Safety Rating',           descEn: 'Maximum 5-star ANCAP safety rating',                                                    descKo: '최고 등급 ANCAP 5스타 안전 인증' },
      { name: '7 Year Unlimited KM Warranty',          descEn: "Kia's 7-year unlimited kilometre manufacturer warranty",                                descKo: '기아 7년 무제한 km 제조사 보증' },
    ],
