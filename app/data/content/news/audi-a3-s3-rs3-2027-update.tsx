...
export default function AudiA3S3Rs32027UpdateContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>Digital Stage Comes to the A3</h2>
          ...
          <h2 style={AS.h2}>Smarter Behind the Wheel</h2>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>MyAudi app</span> now lets you check the status of the parking brake,
            lights, doors, and windows from your phone. Small feature, but genuinely useful before a long trip.
          </p>

          <h2 style={AS.h2}>European Pricing and What to Expect Here</h2>
