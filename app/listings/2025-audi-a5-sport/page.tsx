            ...
            <div style={{ display: "flex", gap: "6px" }}>
              {IMAGES.map((src, i) => (
                <div
                  ...
                  title={IMG_LABELS[i]}
                  style={{
                    flex: 1, height: "52px", borderRadius: "4px", overflow: "hidden", cursor: "pointer",
                    border: activeImg === i ? "1.5px solid #CCDA47" : "0.5px solid #2e2e2e",
          ...
          <div style={{ background: "#242424", border: "0.5px solid #2e2e2e", borderRadius: "8px", padding: "14px", display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "15px", fontWeight: 600, color: "#ddd", lineHeight: 1.35, marginBottom: "4px" }}>
                ...
                <span style={{ fontSize: "13px", fontWeight: 400, color: "#888" }}>2.0L Turbo · Quattro AWD · S tronic</span>
              </div>
              <div style={{ fontSize: "11px", color: "#555" }}>Artarmon, Sydney · 2,500 km</div>
            </div>
