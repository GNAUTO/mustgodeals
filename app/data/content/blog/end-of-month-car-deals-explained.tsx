...
export default function EndOfMonthCarDealsExplainedContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>Why dealers must sell before month end</h2>
          ...
          <h3 style={AS.h3}>Holdback — the hidden payment</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Stair-step bonuses — where it gets interesting</h3>
          <p style={AS.p}>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>$500 per unit</span> — that&rsquo;s $15,000 in bonus
          ...
          <div style={AS.tipBox}>
            <div style={AS.tipTitle}>MANUFACTURER INCENTIVE TERMS — PLAIN ENGLISH</div>
            <ul style={AS.tipList}>
              <li style={AS.tipItem}><strong>Holdback:</strong> A hidden rebate (2–3% of wholesale price) paid to dealers by the manufacturer after each sale</li>
              <li style={AS.tipItem}><strong>Stair-step bonus:</strong> A large payment triggered when a dealer hits a monthly sales target — applied to every car sold that month</li>
              <li style={AS.tipItem}><strong>Floorplan assistance:</strong> Manufacturer subsidy covering the cost of keeping unsold vehicles in the dealer&rsquo;s yard</li>
              <li style={AS.tipItem}><strong>Demo allowance:</strong> Additional margin given to dealers when they sell demonstrator vehicles</li>
            </ul>
          </div>

          <h2 style={AS.h2}>The golden timing window</h2>
          ...
          <h3 style={AS.h3}>Last 3–5 business days</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Weekday afternoons beat weekends</h3>
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>Tuesday or Wednesday afternoon</span>, with a quiet floor
          ...
          <h3 style={AS.h3}>Quarter-end and year-end stack the pressure even higher</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Aged stock is costing them money every week</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Demo cars are often the best value in the market</h3>
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>10–15% from the new car price</span> just to clear them.
          ...
          <h3 style={AS.h3}>Finance commissions are built into your interest rate</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>The trade-in trap</h3>
          <p style={AS.p}>
          ...
          <div style={AS.tipBox}>
            <div style={AS.tipTitle}>PRE-VISIT CHECKLIST</div>
            <ul style={AS.tipList}>
              <li style={AS.tipItem}>Check the driveaway price on RedBook.com.au for your target vehicle</li>
              <li style={AS.tipItem}>Get quotes from at least 2–3 dealerships for the same make and model</li>
              <li style={AS.tipItem}>Ask how long the specific vehicle has been in stock</li>
              <li style={AS.tipItem}>Get a bank or credit union pre-approval before visiting</li>
              <li style={AS.tipItem}>Get an independent trade-in valuation if applicable</li>
              <li style={AS.tipItem}>Visit on a weekday afternoon in the last 5 days of the month</li>
            </ul>
          </div>

          <h2 style={AS.h2}>Step-by-step negotiation strategy</h2>
          ...
          <h3 style={AS.h3}>Step 1 — Always negotiate the driveaway price</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Step 2 — Let them make the first offer</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Step 3 — Use competing quotes as leverage</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Step 4 — Be willing to walk away</h3>
          <p style={AS.p}>
          ...
          <h2 style={AS.h2}>How to counter common dealer tactics</h2>

          <h3 style={AS.h3}>&ldquo;Let me talk to my manager&rdquo;</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>The four-square worksheet</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>Artificial urgency</h3>
          <p style={AS.p}>
          ...
          <h3 style={AS.h3}>After-sale add-ons</h3>
          <p style={AS.p}>
          ...
          <div style={AS.tipBox}>
            <div style={AS.tipTitle}>QUESTIONS TO ASK BEFORE YOU SIGN</div>
            <ul style={AS.tipList}>
              <li style={AS.tipItem}>&ldquo;What is the total driveaway price, all-inclusive?&rdquo;</li>
              <li style={AS.tipItem}>&ldquo;How long has this specific vehicle been in your yard?&rdquo;</li>
              <li style={AS.tipItem}>&ldquo;Do you have any demonstrators available in this model?&rdquo;</li>
              <li style={AS.tipItem}>&ldquo;Is this your best price, or is there any flexibility?&rdquo;</li>
              <li style={AS.tipItem}>&ldquo;Can you match [competitor dealership] who offered me $X driveaway?&rdquo;</li>
              <li style={AS.tipItem}>&ldquo;What interest rate are you offering, and can you do better?&rdquo;</li>
            </ul>
          </div>
