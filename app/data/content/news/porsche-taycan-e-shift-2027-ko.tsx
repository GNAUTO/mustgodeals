  ...
  return (
    <>
          ...
          <div style={AS.imgWrap}>
            ...
            />
            <p style={AS.imgCaption}>이미지: Porsche Media</p>
          </div>
          ...
          <h2 style={AS.h2}>E-Shift는 실제로 무엇을 하는가</h2>
          ...
          <h2 style={AS.h2}>어떻게 선택하나, 그리고 누가 기본으로 받나</h2>

          <p style={AS.p}>
            타이칸 세단, 크로스 투리스모, 스포츠 투리스모에서 E-Shift는 옵션 패키지로 구성해야 한다.
            패들 시프터가 달린 플랫-바텀 알칸타라 휠인{" "}
            <span style={AS.highlight}>GT 스포츠 스티어링 휠</span>과 함께 묶여있다. 추가 비용이
            들지만, 스포티한 타이칸을 구성하는 구매자라면 어차피 고려하게 될 옵션이다.
          </p>

          <div style={AS.callout}>
            <div style={AS.calloutTitle}>터보 GT: E-SHIFT 기본 탑재</div>
          ...
          <h2 style={AS.h2}>MY27의 다른 변화들</h2>
          ...
          <p style={AS.p}>
            기존에는 상위 트림에만 적용됐던{" "}
            <span style={AS.highlight}>105kWh 퍼포먼스 배터리 플러스</span>가 전 트림 기본 사양으로
          ...
          <p style={AS.p}>
            ...
            기능이 더해진다. 무선 충전은 <span style={AS.highlight}>15W</span>로 향상됐다. 더 저렴한
          ...
          {/* CTA */}
          <div style={AS.ctaBox}>
            <div style={AS.ctaTitle}>신차 출시 알림 받기</div>
            <p style={AS.ctaDesc}>최신 자동차 딜과 신차 소식을 매주 이메일로 받아보세요</p>
