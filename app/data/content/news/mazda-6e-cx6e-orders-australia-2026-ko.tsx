...
export default function Mazda6eCx6eOrdersAustralia2026KoContent() {
  return (
    <>
          ...
          <p style={AS.p}>
            ...
            진행했고,{" "}
            <span style={AS.highlight}>300대 전량이 단 2주 만에 완판</span>됐다. 이제 CX-6e
          ...
          <h2 style={AS.h2}>차량 스펙은?</h2>

          <p style={AS.p}>
            마즈다 6e는 온로드 비용 제외{" "}
            <span style={AS.highlight}>$49,990부터</span> 시작하며, 첫 출고는 2026년 7월 예정이다.
            WLTP 기준{" "}
            <span style={AS.highlight}>560km 주행거리</span>를 갖춘 전용 EV 플랫폼 기반 차량으로,
            기존 Mazda6보다 크고 넉넉한 공간과 높은 수준의 기술을 갖췄다.
          </p>

          <p style={AS.p}>
            CX-6e SUV는 온로드 비용 제외{" "}
            <span style={AS.highlight}>$53,990부터</span> 시작하며, 첫 출고는 2026년 9월부터다.
            78kWh LFP 배터리와 190kW 후륜 모터를 탑재했고, WLTP 기준{" "}
            <span style={AS.highlight}>484km 주행거리</span>와 30~80% 급속충전 15분을 달성했다.
          </p>

          <div style={AS.callout}>
            <div style={AS.calloutTitle}>사전 주문 혜택</div>
          ...
          <h2 style={AS.h2}>경쟁 모델 대비 가격</h2>

          <p style={AS.p}>
            CX-6e의 시작가 $53,990은{" "}
            <span style={AS.highlight}>테슬라 모델 Y 대비 약 $5,000</span>, BYD 실리온 7 대비
