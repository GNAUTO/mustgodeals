...
export default function MazdaSalesDipAustralia2026KoContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>실제로 무슨 일이 일어난 걸까</h2>
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>빈디의 발언</div>
          ...
          <h2 style={AS.h2}>CX-5는 여전히 주력이다</h2>
          ...
          <p style={AS.p}>
            빈디는 올해{" "}
            <span style={AS.highlight}>CX-5 연간 목표 2만 5천 대</span>는 여전히 달성
          ...
          <p style={AS.p}>
            ...
            마쯔다3은 연초부터 5월까지{" "}
            <span style={AS.highlight}>3,356대로 26% 감소</span>했고,
            노후화된 CX-3는{" "}
            <span style={AS.highlight}>3,776대로 21.4% 줄었다</span>. BT-50 픽업트럭도
            HiLux와 Ranger가 지배하는 세그먼트에서{" "}
            <span style={AS.highlight}>21% 빠진 5,021대</span>에 그쳤다.
          </p>
          ...
          <div style={AS.ctaBox}>
            <div style={AS.ctaTitle}>데모카 특가를 찾고 계신가요?</div>
            <p style={AS.ctaDesc}>
