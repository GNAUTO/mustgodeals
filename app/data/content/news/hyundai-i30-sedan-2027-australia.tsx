  ...
  return (
    <>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>first half of 2027</span>.
          </p>
          ...
          <div style={AS.imgWrap}>
            ...
            />
            <p style={AS.imgCaption}>Image: Hyundai</p>
          </div>

          <h2 style={AS.h2}>The Name Stays — for Australia, at Least</h2>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>i30 Sedan</span> nameplate — a badge that carries genuine recognition
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>DIMENSIONS VS CURRENT MODEL</div>
          ...
          <h2 style={AS.h2}>Hybrid Is Now the Focus</h2>
          ...
          <p style={AS.p}>
            ...
            has upgraded the <span style={AS.highlight}>1.6L hybrid system</span> to a combined output of{" "}
            <span style={AS.highlight}>117kW</span> — up from 104kW in the current model. A 2.0L naturally
          ...
          <p style={AS.p}>
            A new <span style={AS.highlight}>Predictive Drive Control</span> feature uses your navigation
            ...
            intelligent, not just a marketing claim. Pair that with <span style={AS.highlight}>Stay Mode</span>{" "}
          ...
          <h2 style={AS.h2}>Inside: Screens Get Serious</h2>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>Pleos Connect</span> infotainment system — built on Android Automotive
            OS, first seen on the Ioniq 3 — arrives with a choice of{" "}
            <span style={AS.highlight}>12.9-inch or 14.6-inch</span> touchscreen. The current car tops out at
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>column-mounted stalk</span> — a first for the Australian i30 Sedan — with
          ...
          <h2 style={AS.h2}>Design: Art of Steel</h2>
          ...
          <p style={AS.p}>
            Hyundai calls the new design language <span style={AS.highlight}>&ldquo;Art of Steel&rdquo;</span> —
            and the execution is clean without being anonymous. Flush door handles, a distinctive{" "}
            <span style={AS.highlight}>H-shaped lighting signature</span> front and rear, and taut body
          ...
          <h2 style={AS.h2}>When Can You Expect It?</h2>

          <p style={AS.p}>
            Korean sales open in <span style={AS.highlight}>September 2026</span>. Australian deliveries are
            expected in the <span style={AS.highlight}>first half of 2027</span>. Pricing hasn&apos;t been
            ...
            <span style={AS.highlight}>i30 Sedan N</span> performance variant is also expected, potentially
          ...
          <div style={AS.ctaBox}>
            <div style={AS.ctaTitle}>Get demo car alerts before they&apos;re gone</div>
            <p style={AS.ctaDesc}>Current-gen i30 Sedan demos won&apos;t last once the new model lands</p>
