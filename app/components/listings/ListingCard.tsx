  ...
  if (listing.status === "coming_soon") {
    return (
      <div style={{ background: "#fff", borderRadius: "8px", border: "0.5px solid #e0e0e0", overflow: "hidden", opacity: 0.5, pointerEvents: "none" }}>
        <div style={{ aspectRatio: "16/9", background: "#e8e8e8", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          <CarIcon />
  ...
  if (listing.status === "sold") {
    return (
      <div style={{ background: "#fff", borderRadius: "8px", border: "0.5px solid #e0e0e0", overflow: "hidden", opacity: 0.35, pointerEvents: "none" }}>
        <div style={{ aspectRatio: "16/9", background: "#f5f5f5", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          <CarIcon />
    ...
    <Link href={`/listings/${listing.slug}`} style={{ textDecoration: "none", display: "block" }}>
      ...
      >
        ...
        <div style={{ padding: "16px" }}>
          ...
          <div style={{ width: "100%", padding: "15px 10px", background: "#CCDA47", color: "#1A1A1A", borderRadius: "6px", fontSize: "13px", fontWeight: 600, textAlign: "center", transition: "opacity 0.15s, transform 0.15s", opacity: hovered ? 0.9 : 1, transform: hovered ? "scale(1.01)" : "none" }}>
            View listing →
          </div>
        </div>
      </div>
