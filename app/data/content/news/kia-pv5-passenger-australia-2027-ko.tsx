...
export default function KiaPv5PassengerAustralia2027KoContent() {
  return (
    <>
          ...
          <p style={AS.p}>
            PV5 패신저는 기아의 전용{" "}
            <span style={AS.highlight}>E-GMP.S 플랫폼</span> 위에 올라선 7인승 3열
          ...
          <h2 style={AS.h2}>주행거리와 충전</h2>

          <p style={AS.p}>
            PV5 전 라인업은 전륜구동 단일 모터(
            <span style={AS.highlight}>120kW, 250Nm</span>)를 공유한다. 한국 시장
            7인승 PV5 패신저의 공인 주행거리는 358km이며, 호주 사양 PV5 카고가
            WLTP 기준 416km를 기록한다는 점을 감안하면 패신저는 현지 튜닝 후{" "}
            <span style={AS.highlight}>390km 안팎</span>이 될 것으로 예상된다.
          </p>
          ...
          <h2 style={AS.h2}>호주 시장에서 주목받는 이유</h2>
