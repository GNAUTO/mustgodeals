...
export default function SkodaPeaq2027AustraliaContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>Three Powertrains, One Platform</h2>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}>10 to 80 per cent in just 28 minutes</span>. That&rsquo;s a
          ...
          <h2 style={AS.h2}>Technology Inside and Out</h2>
          ...
          <h2 style={AS.h2}>What to Expect in Australia</h2>
