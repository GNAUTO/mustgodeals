...
export default function MazdaSalesDipAustralia2026Content() {
  return (
    <>
          ...
          <h2 style={AS.h2}>So What&rsquo;s Actually Going On?</h2>
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>WHAT BHINDI SAID</div>
          ...
          <h2 style={AS.h2}>The CX-5 Is Still Doing the Heavy Lifting</h2>
          ...
          <p style={AS.p}>
            ...
            dropped{" "}
            <span style={AS.highlight}>21% to 5,021 units</span> in a segment that continues to be
          ...
          <h2 style={AS.h2}>The Electric Counter-Punch</h2>
