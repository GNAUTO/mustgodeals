...
export default function NovatedLeaseAustraliaContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>What Is a Novated Lease?</h2>
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>SAVINGS EXAMPLE</div>
          ...
          <p style={AS.p}>
            ...
            ATO charges <span style={AS.highlight}>Fringe Benefits Tax (FBT)</span>. How your lease
          ...
          <h2 style={AS.h2}>EVs Change the Equation</h2>
          ...
          <h2 style={AS.h2}>Is It Right for You?</h2>

          <div style={AS.tipBox}>
            <div style={AS.tipTitle}>NOVATED LEASING WORKS WELL IF YOU</div>
            <ul style={AS.tipList}>
              <li style={AS.tipItem}>Earn $70,000+ (higher tax bracket = bigger savings)</li>
              <li style={AS.tipItem}>Drive regularly throughout the year</li>
              <li style={AS.tipItem}>Are considering an EV or PHEV</li>
            </ul>
          </div>
