...
export default function BmwX52027FivePowertrainsKoContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>라인업 한눈에 보기</h2>

          <p style={AS.p}>
            X5 40 xDrive는 <span style={AS.highlight}>400마력</span>, X5 50e xDrive
            플러그인 하이브리드는 <span style={AS.highlight}>490마력</span>, iX5 60 xDrive
            전기 모델은 <span style={AS.highlight}>578마력</span>을 발휘한다.
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>iX5 충전 성능</div>
          ...
          <h2 style={AS.h2}>수소는 2028년에</h2>

          <p style={AS.p}>
            수소 연료전지 모델 iX5 Hydrogen은 토요타와의 협업으로 개발되며{" "}
            <span style={AS.highlight}>2028년 출시 예정</span>이다. BMW와 토요타는
          ...
          <h2 style={AS.h2}>호주 출시는 언제?</h2>

          <p style={AS.p}>
            2027 BMW X5는 <span style={AS.highlight}>2026년 10월&ndash;12월</span> 사이
