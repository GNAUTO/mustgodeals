...
export default function MaseratiGrecale2027AustraliaKoContent() {
  return (
    <>
          ...
          <h2 style={AS.h2}>폴고레 EV, 실질적인 주행 가능 거리 확보</h2>

          <p style={AS.p}>
            전기차 모델인 폴고레는 2027년형 업데이트에서 배터리 팩을 대폭 개선했다. 용량이
            기존 105kWh에서 118kWh로 늘어나 WLTP 기준 주행 가능 거리가 464km에서{" "}
            <span style={AS.highlight}>약 535km</span>로 향상됐다. 마세라티는 고온 환경에서의
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>폴고레 충전 성능 업데이트</div>
          ...
          <h2 style={AS.h2}>실내 업데이트 및 외관 변화</h2>
          ...
          <h2 style={AS.h2}>호주 출시 가격 및 일정</h2>

          <p style={AS.p}>
            마세라티 호주 법인은 아직 2027년형 가격을 공개하지 않았다. 현행 그레칼레 라인업의
            호주 판매 가격은 2.0리터 4기통 GT 트림이{" "}
            <span style={AS.highlight}>약 129,990달러(드라이브어웨이)</span>부터 시작해,
