...
export default function PorscheTaycanEShift2027Content() {
  return (
    <>
          ...
          <div style={AS.imgWrap}>
            ...
            />
            <p style={AS.imgCaption}>Image: Porsche Media</p>
          </div>
          ...
          <h2 style={AS.h2}>What E-Shift actually does</h2>
          ...
          <h2 style={AS.h2}>The Hyundai connection</h2>
          ...
          <p style={AS.p}>
            ...
            E-Shift is part of an optional package that includes the <span style={AS.highlight}>GT
          ...
          <div style={AS.callout}>
            <div style={AS.calloutTitle}>TURBO GT: E-SHIFT STANDARD</div>
          ...
          <h2 style={AS.h2}>What else changes for MY27</h2>
          ...
          <p style={AS.p}>
            The <span style={AS.highlight}>105kWh Performance Battery Plus</span> &mdash; previously
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}> 15W</span>, which is a small but noticeable upgrade for
          ...
          <h2 style={AS.h2}>Australia: timing and pricing</h2>
          ...
          <p style={AS.p}>
            ...
            <span style={AS.highlight}> $183,000 drive away</span> for the base model &mdash; and
          ...
          {/* CTA */}
          <div style={AS.ctaBox}>
            <div style={AS.ctaTitle}>Stay ahead of every new launch</div>
            <p style={AS.ctaDesc}>New model alerts and clearance deals delivered to your inbox weekly</p>
