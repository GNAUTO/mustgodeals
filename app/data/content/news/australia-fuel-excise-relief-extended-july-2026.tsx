...
export default function AustraliaFuelExciseReliefExtendedJuly2026Content() {
  return (
    <>
          ...
          <h2 style={AS.h2}>What&rsquo;s Happening</h2>

          <p style={AS.p}>
            The fuel excise rate is being reduced from{" "}
            <span style={AS.highlight}>32 cents to 16 cents per litre</span> for the period of
            ...
            <span style={AS.highlight}>$2.9 billion</span> in foregone revenue.
          </p>
          ...
          <p style={AS.p}>
            ...
            diesel prices are down <span style={AS.highlight}>39%</span> and petrol prices are down{" "}
            <span style={AS.highlight}>36%</span> across Australia&rsquo;s five largest cities.
          </p>

          <div style={AS.callout}>
            <div style={AS.calloutTitle}>PRICE IMPACT SINCE MARCH</div>
          ...
          <h2 style={AS.h2}>How Long Will It Last?</h2>

          <p style={AS.p}>
            This extension is temporary. The relief runs from{" "}
            <span style={AS.highlight}>1 July to 2 August 2026</span>, after which a graduated
